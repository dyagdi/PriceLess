    ...
    async def parse_category_page(self, response):
        try:
            ...
            for product_card in product_cards:
                ...
                # Extract image URL (src or data-src)
                image_url = product_card.css("img::attr(src)").get()
                if not image_url:
                    image_url = product_card.css("img::attr(data-src)").get()

                #print("################################################")
                # Debugging: print the image URL and product details
                #print(product_card)
                #print(f"Product: {product_name}, Image URL: {image_url}")
                #print("################################################")
